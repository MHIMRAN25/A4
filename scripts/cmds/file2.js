...
module.exports = {
  ...
  run: async ({ message, args, sendMessage, downloadReply, awaitReply }) => {
    try {
      ...
      if (sub === "list") {
        ...
        return await sendMessage(chatId, `📂 সার্ভারের ফাইলসমূহ:\n• ${files.join("\n• ")}`);
      }
      ...
      if (sub === "remove" || sub === "delete") {
        ...
        const reply = await awaitReply(chatId, 30000); // 30 সেকেন্ডের মধ্যে ইউজারের উত্তর আশা করবে

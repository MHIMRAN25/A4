...
module.exports = {
  config:{
    ...
    longDescription: "Send Money, Cash Out, Recharge, Bank Deposit/Withdraw, History, Owner Panel with stylish receipt. Dual Text+Button mode."
  },
